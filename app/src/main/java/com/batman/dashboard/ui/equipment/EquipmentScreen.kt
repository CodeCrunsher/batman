...
fun EquipmentCard(
    ...
    GlassCard(
        ...
        borderColor = statusColor.copy(alpha = if (item.isEnabled) 0.5f else 0.2f)
    ) {
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Box(
                ...
                Icon(icon, contentDescription = null, tint = if (item.isEnabled) statusColor else TextDisabled, modifier = Modifier.size(26.dp))
            }
